...
void GermanStringCountExisting(benchmark::State &state)
{
    ...
    const gs::german_string small_known_string(SMALL_KNOWN_STRING, static_cast<uint32_t>(std::strlen(SMALL_KNOWN_STRING)), gs::persistent_t{});
    const gs::german_string large_known_string(LARGE_KNOWN_STRING, static_cast<uint32_t>(std::strlen(LARGE_KNOWN_STRING)), gs::persistent_t{});
